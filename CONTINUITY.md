...
6. После стабилизации бокса: старт Ф-A `STRATEGIC_PLAN_v5.md` (сначала A5 feedback-петля +
   A1 дайджест обязательств + спот-чек 20-30 звонков как замер по Ст.2.3).
