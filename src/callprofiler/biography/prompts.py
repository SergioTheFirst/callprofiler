...
# Per-pass input budgets used by every build_*_prompt below (TokenBudget.allocate/
# trim_one/max_chars). Was deleted in 5c0cb79 as "legacy" while all 13 call sites
# stayed → NameError on every biography pass (caught by CI flake8 F821, 2026-08-21).
# calculate_dynamic_budget() is a separate, optional scaler — not a replacement.
BUDGETS = {
    ...
    "p8_editorial": TokenBudget(18000, {"prose": 1.0}),
