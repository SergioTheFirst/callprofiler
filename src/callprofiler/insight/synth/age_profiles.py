...
AGE_TEMPLATES: dict[str, AgeStyleTemplate] = {
    ...
    "G4": AgeStyleTemplate(
        # B-фикс реализма: рождённый ~1985 НЕ говорит советизмами («сберкнижка»
        # 5% плотности был подгон под v1-таблицы и глушил денди/сегу в реалиях)
        ...
        slang_density=0.0, archaism_density=0.0, long_word_ratio=0.30,
    ),
    "G5": AgeStyleTemplate(
