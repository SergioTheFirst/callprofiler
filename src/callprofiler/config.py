...
class ModelsConfig:
    ...
    asr_min_coverage: float = 0.8     # T-07: минимальное покрытие ASR (успешные окна / всего), гейт перед stage 2
...
def load_config(path: str, validate: bool = True) -> Config:
    ...
    if "models" in raw:
        ...
        cfg.models = ModelsConfig(
            ...
            asr_min_coverage=float(m.get("asr_min_coverage", cfg.models.asr_min_coverage)),
