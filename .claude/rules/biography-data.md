...
- Длина главы: **2500-4500 слов при достаточном материале**. Без минимума
  если данных мало — пиши честно и кратко, без воды. Плотная двухсотсловная
  глава лучше раздутой пустой тысячи.
