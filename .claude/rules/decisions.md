...
получат «данных мало» — это главный эффект честности (S-2). Место: T-26 после CP-5 как конкретизация
D-01 `sintezdiharea.md`. Следующий шаг — `docs/research/bs/box-package/` на боксе (R-01, E-0a/E-1).
