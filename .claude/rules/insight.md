...
src/callprofiler/insight/
  repository.py  feature_store.py  archetypes.py  cli_ops.py  labels.py  cards.py
...
кластеров (детерминированные уже есть; LLM-шов на боксе) · Фаза 7 визуализация (карта/эго-сеть/ЭКГ).
