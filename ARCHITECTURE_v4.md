> ⚠️ **SUPERSEDED (2026-05-29).** Этот документ описывает систему только до Фазы 4
> (pipeline + карточки + contact_summaries). С тех пор построены слои Knowledge Graph
> и Biography + Dashboard v3. **Актуальная архитектура и источник истины — `ARCHITECTURE_v5.md`.**
