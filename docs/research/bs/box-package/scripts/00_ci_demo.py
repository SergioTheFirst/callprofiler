...
BANDS = [(0.8, 1.0001, "держит слово"), (0.6, 0.8, "в основном держит"),
         (0.4, 0.6, "через раз"), (0.2, 0.4, "чаще не выполняет"), (0.0, 0.2, "почти не выполняет")]
